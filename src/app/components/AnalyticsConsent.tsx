...
export default function AnalyticsConsent() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-[100] mx-auto max-w-2xl rounded-2xl border border-slate-300 bg-white p-4 shadow-2xl dark:border-slate-700 dark:bg-slate-900 sm:p-5">
      <p className="font-semibold text-slate-900 dark:text-white">Help improve YardPilotUSA</p>
      <p className="mt-1 text-sm leading-6 text-slate-600 dark:text-slate-300">
        YardPilotUSA can collect privacy-limited usage analytics. We do not intentionally send names,
