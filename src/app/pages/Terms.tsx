...
const sections = [
  ["1. Service and beta status", "YardPilot provides software for landscaping businesses, workers, and clients, including workspaces, contacts, estimates, approvals, jobs, scheduling, follow-ups, invoices, subscriptions, marketplace listings, bids, applications, and related records. Beta features may change, be interrupted, or contain defects. Keep independent copies of critical records."],
  ...
  ["4. Marketplace", "Client requests, business bids, openings, applications, and listings are introductions rather than guarantees. YardPilot is not the employer, contractor, client, insurer, licensing authority, or guarantor. The Marketplace Terms and Acceptable Use Policy apply."],
  ["5. Payments and subscriptions", "YardPilot Pro subscriptions are billed through Stripe according to the checkout and billing portal. Landscaping invoice payments are processed for the connected landscaping business. YardPilot does not presently provide payroll. Employee payment records are a ledger and do not calculate withholding, file tax forms, or transmit wages."],
  ...
  ["8. Business verification", "Any verification badge confirms only the specific registry information stated by YardPilot at the recorded time. It does not verify quality, insurance, licensing, tax compliance, background, safety, or suitability."],
  ["9. Availability, suspension, and termination", "YardPilot may restrict access to protect users, enforce policies, investigate fraud or security incidents, comply with law, or prevent platform abuse. Data retention and deletion are governed by the Privacy Policy and applicable recordkeeping needs."],
  ["10. Disclaimers and responsibility", "To the extent allowed by law, YardPilot is provided without guarantees that every feature will be uninterrupted, error-free, legally sufficient, or suitable for a particular project. Users remain responsible for business, hiring, employment, payroll, tax, insurance, licensing, safety, and contract decisions."],
  ["11. Contact", "Questions about these terms may be submitted through the YardPilot support page."],
] as const;
