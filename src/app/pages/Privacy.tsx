...
const sections = [
  ...
  ["Payments and providers", "Stripe processes YardPilot subscriptions and connected-business invoice payments. Supabase provides authentication, database, Edge Functions, and storage; Vercel hosts the web application; Google may provide optional sign-in; and configured email or monitoring providers may process operational messages. Their own terms and privacy practices also apply."],
  ["Analytics and error reports", "When a user grants analytics consent, YardPilot may collect privacy-limited product events and page paths. YardPilot is designed not to intentionally send names, email addresses, client addresses, estimate descriptions, resumes, access codes, or payment details to analytics. Technical error reports may include route, browser summary, app version, and stack trace."],
  ["Security", "YardPilot uses authentication, row-level security, role checks, private storage policies, webhook signatures, access-code hashing, and audit records. No system is perfectly secure. Users must protect credentials, avoid sharing secrets, and report suspected unauthorized access promptly."],
