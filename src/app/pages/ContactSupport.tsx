...
export default function ContactSupport() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    setNotice(delivery === "delivered"
      ? "Your message was saved and emailed to YardPilotUSA support."
      : "Your message was saved in the YardPilotUSA support inbox. Email delivery is not fully configured yet, so check back with support@yardpilotusa.com if urgent.");
