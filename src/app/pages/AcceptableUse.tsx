    ...
    <main className="min-h-screen bg-slate-100 px-4 py-10 dark:bg-slate-950">
      <article className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700 dark:text-slate-300">
          <section><h2 className="text-lg font-bold text-slate-900 dark:text-white">Allowed use</h2><p>Use YardPilot for lawful landscaping, property-service, hiring, marketplace, estimate, invoice, and team-management activity for which you have authority and a legitimate business purpose.</p></section>
          ...
          <section><h2 className="text-lg font-bold text-slate-900 dark:text-white">Enforcement</h2><p>YardPilot may restrict content or access while investigating security, fraud, marketplace, legal, or safety concerns. Users may contact support to request review of an enforcement decision.</p></section>
        </div>
