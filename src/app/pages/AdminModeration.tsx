...
export default function AdminModeration() {
  ...
  return <div className="mx-auto max-w-6xl space-y-6 p-4 sm:p-7">
    <div><h1 className="text-2xl font-bold text-slate-900 dark:text-white">YardPilot moderation</h1><p className="mt-1 text-sm text-slate-500">Review verified-project reviews and recent support submissions. Negative reviews should not be rejected merely because they are negative.</p></div>
