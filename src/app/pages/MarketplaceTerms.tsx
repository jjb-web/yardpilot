    ...
    <main className="min-h-screen bg-slate-100 px-4 py-10 dark:bg-slate-950">
      <article className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700 dark:text-slate-300">
          <section><h2 className="text-lg font-bold text-slate-900 dark:text-white">YardPilot’s role</h2><p>YardPilot provides software that helps clients and landscaping businesses discover each other, post requests, submit bids, publish openings, and manage resulting estimates and invoices. YardPilot is not the employer, contractor, property owner, payroll provider, insurer, licensing authority, or guarantor of a transaction.</p></section>
          ...
          <section><h2 className="text-lg font-bold text-slate-900 dark:text-white">Verification and reviews</h2><p>A business-registration badge, when present, confirms only the limited registry information stated by YardPilot. It does not verify quality, insurance, contractor licensing, tax compliance, safety, identity beyond the stated check, or fitness for a project. Reviews may be moderated and must reflect genuine experiences.</p></section>
